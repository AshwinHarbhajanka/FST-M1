...
public class Activity5 {
	...
	public void chrome2() {
		...
		driver.findElement(MobileBy
				.AndroidUIAutomator("UiScrollable(UiSelector().scrollable(true)).scrollTextIntoView(\"Login Form\")"))
				.click();
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//android.view.View[@text='Login Form']")));
		System.out.println(driver.findElement(By.xpath("//android.view.View[@text='Login Form']")).getText());
